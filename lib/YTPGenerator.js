    ...
    class {
        ...
        async configurateAndGo(options) {
            return new Promise(async (resolve,reject) => {
                ...
                this.toolBox.setTemp((options.temp != undefined ? options.temp : "./temp")+"/job_" + (options.date != undefined ? options.date : new Date()).getTime() + "/");
                ...
                try {
                    ...
                    setTimeout(async function() {
                        ...
                        if(isok) {
                            var okbuddy
                            okbuddy = await oh.toolBox.concatenateVideo(max, oh.OUTPUT_FILE).catch(()=>{return reject("concat-fail")})
                            while(okbuddy == undefined || okbuddy == null) {
                                setTimeout(() => {}, 500)
                            }
